...
For the Fernet-style key/value encryption used by `omkit.encryption` (and re-
exported via `omkit.internal.crypto`) use that module instead — it is a
separate, non-interop primitive.
