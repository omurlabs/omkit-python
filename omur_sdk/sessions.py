...
def backend_from_env() -> str:
    """
    Rules:   Function reads OMUR_SESSION_BACKEND environment variable and returns "postgres" if not set or invalid, raising ValueError for unknown values. Caller must ensure environment variable is properly set or handle potential ValueError exceptions.
    """
